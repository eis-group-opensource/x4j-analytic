...
//        workbook.setPrintArea(0, -1, -1, 0, 0);
        workbook.getSheetAt(0).setRepeatingRows(new CellRangeAddress(0, 0, -1, -1));
    ...
    public void testParseMultipleRows() {
        XSSFWorkbook workbook = new XSSFWorkbook();
        workbook.createSheet();
        workbook.getSheetAt(0).setRepeatingRows(new CellRangeAddress(0, 3, -1, -1));
        int[] repeatingRows = XSSFSheetHelper.getRepeatingRows(workbook, 0);
    ...
    public void testParseMultipleRowsMultipleSheets() {
        ...
        workbook.createSheet();
        workbook.getSheetAt(0).setRepeatingRows(new CellRangeAddress(0, 3, -1, -1));
        workbook.getSheetAt(2).setRepeatingRows(new CellRangeAddress(2, 3, -1, -1));
    ...
    public void whenBothRowsAndColsAreRepeated_colsAreIgnored() {
        XSSFWorkbook workbook = new XSSFWorkbook();
        workbook.createSheet();
        workbook.getSheetAt(0).setRepeatingRows(new CellRangeAddress(1, 1, 2, 2));
