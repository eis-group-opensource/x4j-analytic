...
public class TableNode extends Node{
	...
	public TableNode(XSSFSheet sheet, XSSFTable table) {
		super(sheet);	
		this.table = table;
	}
	...
	private void initXMLMap() {
		...
		if(connections == null){
			connections = ((XLSXConnections) workbook.createRelationship(XLSXDescriptorUtils.CONNECTIONS, new XLSXFactory())).getCTConnections();
		}
	}
	...
	public void setTable(XSSFTable table) {
		this.table = table;
	}
}
